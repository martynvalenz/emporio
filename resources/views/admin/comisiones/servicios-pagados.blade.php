...
<div class="table-responsive">
    <h4>Comisiones anexadas al egreso</h4>
    <table id="example1" class="table table-striped table-bordered table-condensed table-hover display table-responsive no-wrap cell-border" cellspacing="0" width="100%">
        ...
        <tbody style="font-size: 15px" id="list" name="list">
            ...
            <tr id="comision{{ $comision->id }}">
                ...
                <td style="width:10%" align="center" title="Quitar comisión" data-tooltip="tooltip"><a class="btn btn-danger btn-xs btn-flat btn-quitar-comision"><i class="fas fa-times"></i></a></td>
            </tr>
            @endforeach
        </tbody>
        <tfoot>
            <tr>
                ...
                <th colspan ="6">&nbsp;</th>
                <th>Total: </th>
                <th style="font-weight: bold; text-align: right; font-size: 15px" align="right">{{ number_format($monto_pagado,2) }}</th>
                <th colspan ="3">&nbsp;</th>
            </tr>
        </tfoot>
    </table>
...
@else
<h4>No hay comisiones pagadas</h4>
@endif