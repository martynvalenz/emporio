    ...
    <table class="table table-striped table-bordered table-condensed table-hover display table-responsive no-wrap cell-border" cellspacing="0" width="100%">
        <thead style="font-size: 15px">
            <tr>
                ...
                <th style="background-color: #ff3300; color:white" title="Alta en Estatus" data-tooltip="tooltip"><i class="fas fa-database"></i></th>
                <th style="background-color: #ff3300; color:white" title="Escaneo" data-tooltip="tooltip"><i class="fa fa-print" aria-hidden="true"></i></th>
                ...
                <th style="background-color: #00ff99" title="Entrega de Título" data-tooltip="tooltip"><i class="fas fa-file-alt"></i></th>
