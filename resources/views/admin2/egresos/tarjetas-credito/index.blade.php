@extends('admin.app')
@section('title')
<title>Emporio Legal | Tarjetas de Crédito</title>
@endsection
@section('styles')
<!-- Toastr -->
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <span>Tarjetas de Crédito </span> <label id="label-estatus" class="label label-warning">Pendientes</label>
        </h1>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="btn-group">
                            <a class="btn btn-primary" id="btn-agregar-egreso" data-target="#modal-tarjeta-credito" data-toggle="modal" data-tooltip="tooltip" title="Agregar un nuevo Egreso"><i class="fa fa-plus"></i> Agregar Egreso
                            </a>
                            @include('admin.egresos.tarjetas-credito.tarjeta-credito')
...
<script src="{{ asset('admin/plugins/datepicker/locales/bootstrap-datepicker.es.js') }}"></script>
    ...
    <script src="{{ asset('archivos/tarjetas-credito.js') }}"></script>
    <script>
        $('#liEgresos').addClass("treeview active");
        $('#subTarjetasCredito').addClass("active");
    </script>
