<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="agregar_razon">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form role="form" action="{{ route('clientes-razones.store') }}" method="post">
      {{ csrf_field() }}
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Teléfono..." name="telefono" id="telefono" value="{{ old('telefono') }}" data-inputmask='"mask": "(###) ###-#### ext ####"' data-mask>
                </div>
              </div>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="URL de subcarpeta..." name="subcarpeta" id="subcarpeta" value="{{ old('subcarpeta') }}">
                </div>
              </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Correo de facturación..." name="correo" id="correo" value="{{ old('correo') }}">
                </div>
              </div>
