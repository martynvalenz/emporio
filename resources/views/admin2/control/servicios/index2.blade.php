        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="btn-group">
                <a class="btn btn-success" title="Agregar registro" data-target="#modal-create" data-toggle="modal"><i class="fa fa-plus"></i> Servicio</a>
                <a data-target="#agregar-cliente" data-toggle="modal" class="btn btn-info" title="Agregar cliente"><i class="fa fa-user-plus"></i> Cliente</a>
                <a data-target="#agregar-cliente" data-toggle="modal" class="btn btn-info" title="Agregar cliente"><i class="fa fa-plus"></i> Marca o Título</a>
                ...
                @foreach($servicios as $key => $servicio)
                  <tr>
                    ...
                    <td style="width:10%;" align="center">
                      <a class="btn btn-xs btn-warning" data-target="#modal-editar-{{ $servicio->id }}" data-toggle="modal" title="Editar">
                        <i class="glyphicon glyphicon-edit"></i>
                      </a>
                      @if($servicio->estatus_cobranza == 1)
                        <a class="btn btn-xs btn-danger" data-target="#modal-inactivar-{{ $servicio->id }}" data-toggle="modal" title="Cancelar">
                          <i class="glyphicon glyphicon-eye-close"></i>
                        </a>
                      @else
                        <a class="btn btn-xs btn-success" data-target="#modal-activar-{{ $servicio->id }}" data-toggle="modal" title="Activar">
