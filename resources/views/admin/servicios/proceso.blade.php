...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Proceso de Servicio: {{ $catalogo->clave }}</h1>
    ...
    <form>
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-footer">
                <a href="{{ route('servicios.index') }}" class="btn btn-warning btn-lg" id="btn-save"><i class="fas fa-arrow-left"></i> Ir a Catálogo</a>
                <input type="hidden" id="id_catalogo_servicio" value="{{ $catalogo->id }}">
                <input type="hidden" id="avance_total" value="{{ $catalogo->avance_total }}">
            </div>
        </div>
