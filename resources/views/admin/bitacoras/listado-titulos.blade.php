...
<div class="table-responsive">
    <table class="table headerfix table-striped table-bordered table-condensed table-hover display no-wrap cell-border" cellspacing="0" width="100%">
        ...
        <tbody style="font-size: 15px" id="list-titulos" name="list-titulos">
            @foreach($servicios as $key => $servicio)
            <tr id="listado-titulos-{{ $servicio->id }}">
                ...
                <td style="width:15%;" align="center">
                    <div class="btn-group">
                        ...
                        @if($servicio->id_control == '' || $servicio->fecha_registro == '')    
                            <a class="btn btn-grey btn-sm" disabled title="No se puede enviar el servicio a estatus debido a que no tiene marca o fecha de registro" data-tooltip="tooltip"><i class="fas fa-external-link-square-alt"></i></a>
                        @else
