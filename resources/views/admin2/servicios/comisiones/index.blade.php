...
@section('title')
<title>Emporio Legal | Comisiones de Servicios</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Comisiones de Servicios</li>
      </ol>
    </section>
...
<script>
  ...
  var Listar = function()
  {
    ...
    if(buscar == '')
    {
      ...
      {
        type: 'get',
        url : '/admin/servicios-comisiones/listado/' + estatus,
    ...
    else
    {
      ...
      {
        type: 'get',
        url : '/admin/servicios-comisiones/buscar/' + buscar,
        success: function(data)
        {
          $('#listado').empty().html(data);
          $(".tooltip").tooltip("hide");
