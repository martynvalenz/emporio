        ...
        <table id="example1" class="table table-striped table-bordered table-condensed table-hover display no-wrap cell-border" cellspacing="0" width="100%">
            ...
            <tbody style="font-size: 15px" id="list" name="list">
                ...
                <tr id="comision{{ $comision->id }}">
                    ...
                    <td style="width:15%;" valign="left" title="{{ $comision->comentarios }}" data-tooltip="tooltip">{{ $comision->nombre }} {{ $comision->apellido }}</td>
                    ...
                    <td style="width: 10%" align="right">% {{ number_format($comision->porcentaje_comision,2) }}</td>
                    ...
                    <td style="width:10%;" align="center">
                        <div class="btn-group">
                            @if($comision->estatus == 'Pagado')
                                <a class="btn btn-xs btn-grey" data-tooltip="tooltip" title="No se puede Editar una comisión ya Pagada, primero debe Cancelar el pago en el módulo de Egresos" disabled>
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a class="btn btn-xs btn-grey" data-tooltip="tooltip" title="No se puede cancelar una comisión Pagada, debe cancelar primero el pago en el módulo de Egresos ." disabled>
                                    <i class="fas fa-times"></i>
                                </a>
                            @elseif($comision->estatus == 'Cancelado')
                                <a class="btn btn-xs btn-grey" data-tooltip="tooltip" title="No se puede Editar una comisión ya Cancelada, primero debe Cancelar el pago en el módulo de Egresos" disabled>
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a class="btn btn-xs btn-grey" data-tooltip="tooltip" title="La comisión ya está Cancelada" disabled>
                                    <i class="fas fa-times"></i>
                                </a>
                            @else
