...
<div class="pagination-negativas">
    {{$servicios->render()}}
</div>
    ...
    <table class="table headerfix table-striped table-bordered table-condensed table-hover display no-wrap cell-border" cellspacing="0" width="100%">
        <thead class="centered">
            <tr>
                ...
                <th>Avance</th>
                <th>Recepción</th>
                <th title="Vencimiento de la negativa" data-tooltip="tooltip">Vencimiento</th>
        ...
        <tbody style="font-size: 15px" id="list-negativas" name="list-negativas">
            @foreach($servicios as $key => $servicio)
            <tr id="listado-negativas-{{ $servicio->id }}">
