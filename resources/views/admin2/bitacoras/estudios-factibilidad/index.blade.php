@extends('admin.app')
@section('title')
<title>Emporio Legal | Estudios de Factibilidad</title>
@endsection
@section('styles')
<!-- Toastr -->
...
@section('main-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Bitácora de Estudios de Factibilidad <label id="label-estatus" class="label label-warning">Pendientes</label>
            </h1>
        ...
        @include('admin.bitacoras.estudios-factibilidad.control-sidebar')
                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="btn-group">
                                ...
                                <a href="#home-taber" data-toggle="control-sidebar"><i class="fas fa-gears"></i></a>
                            </div>
                            <br>
                            <br>
                            <div class="row">
                        ...
                        <!-- Modales de Bitacora -->
                        @include('admin.bitacoras.estudios-factibilidad.recepcion-alta')
                        @include('admin.bitacoras.estudios-factibilidad.registro')
