@extends('admin.app')
@section('title')
<title>Emporio Legal | Nómina y Comisiones</title>
@endsection
@section('styles')
<!-- Toastr -->
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Nómina y Comisiones <label id="label-estatus" class="label label-primary">Liberadas</label>
        </h1>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Nómina y Comisiones</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="btn-group">
                            <a class="btn btn-success" data-toggle="modal" data-target="#modal-comisiones" onclick="CreateComision()"><i class="fas fa-money-bill-alt"></i> Pagar Comisiones</a>
