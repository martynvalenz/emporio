    ...
    <table id="listado-empleados-nomina" class="table table-striped table-bordered table-condensed table-hover display table-responsive no-wrap cell-border" cellspacing="0" width="100%">
        ...
        <tbody style="font-size: 15px" id="list" name="list">
            ...
            <tr id="empleado-{{ $empleado->id }}">
                ...
                <td style="width:13%; font-weight: bold" align="right" valign="middle" contenteditable onchange="ModificarTotalesNomina()" class="nomina_monto">{{ $empleado->sueldo_quincenal }}</td>
        ...
        <tfoot>
            <tr>
                <th colspan ="3">&nbsp;</th>
                <th><a id="btn-calcular-total-nomina" class="btn btn-info btn-sm" onclick="CalcularTotalNomina()">Calcular Total:</a></th>
