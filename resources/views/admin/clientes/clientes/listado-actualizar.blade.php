    ...
    <td style="width:20%;" align="center">
        <div class="btn-group">
            ...
            @if($cliente->carpeta == null)
                <a  title="Agregar Carpeta d  el cliente" class="btn btn-grey btn-xs" data-target="#modal-carpeta" data-toggle="modal" data-tooltip="tooltip" onclick="Carpeta({{ $cliente->id }}, '{{ $cliente->nombre_comercial }}')">
