...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('estudios-factibilidad.index') }}">Estudios de Factibilidad</a></li>
  ...
  <section class="content">
    <div class="box box-default">
      ...
      <div class="box-body">     
        ...
        <form role="form" action="{{ route('estudios-factibilidad.store') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="row">
              ...
              <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <div class="form-group {{ $errors->has('id_control') ? ' has-error' : '' }}">
                  <label for="id_control" class="control-label">Seleccionar Trámite, Marca, Obra o Patente</label>
                  <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-registered"></i></span>
                      <select name="id_control" id="id_control" class="form-control">
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
              <div class="form-group">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    <input type="text" id="costo_ini" name="costo_ini" class="form-control" disabled>
                </div>
              </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-4 col-xs-1S2">
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <div class="form-group {{ $errors->has('comision_venta') ? ' has-error' : '' }}">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    <input type="number" id="comision_venta" class="form-control" disabled>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <div class="form-group {{ $errors->has('comision_operativa') ? ' has-error' : '' }}">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    <input type="number" id="comision_operativa" class="form-control" disabled>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <div class="form-group {{ $errors->has('comision_gestion') ? ' has-error' : '' }}">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    <input type="number" id="comision_gestion" class="form-control" disabled>
          ...
          <div class="form-group pull-right">
            ...
            <a href="{{ route('estudios-factibilidad.index') }}" type="button" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Regresar
            </a>
...
<script>
  ...
  $('#subEstudiosFactibilidad').addClass("active");
</script>
