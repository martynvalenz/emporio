...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <span id="titulo-egresos">Estados de Cuenta </span> <label id="label-estatus" class="label label-success">Pagados</label>
        </h1>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="btn-group">
                            <a class="btn btn-primary btn-flat" id="btn-agregar-ingreso" data-target="#egresos" data-toggle="modal" data-tooltip="tooltip" title="Agregar un nuevo Egreso"><i class="fa fa-plus"></i> Agregar Ingreso
                            </a>
                            <a class="btn btn-warning btn-flat" id="btn-agregar-egreso" data-target="#egresos" data-toggle="modal" data-tooltip="tooltip" title="Agregar un nuevo Egreso"><i class="fa fa-minus"></i> Agregar Egreso
                            </a>
                            @include('admin.egresos.generales.egresos')
                            <a id="btn-exportar-estado" class="btn btn-default btn-flat"><i class="fas fa-file-excel"></i> Exportar</a>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                ...
                                                <li><a id="tipo_ingreso" style="color: black">Ingresos</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-6 col-xs-6" hidden>
                                <div class="form-group">
                                    <label>Estatus de Cobro</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fab fa-font-awesome-flag"></i></span>
                                        <div class="dropdown">
                                            <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right" id="reservation" value="{{ $fecha_inicio }}  -  {{ $fecha_fin }}">
...
<script src="{{ asset('admin/plugins/datepicker/locales/bootstrap-datepicker.es.js') }}"></script>
    ...
    <script>
        ...
        $('#subEstadosCuenta').addClass("active");
    </script>
