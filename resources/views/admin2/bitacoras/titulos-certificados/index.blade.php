@extends('admin.app')
@section('title')
<title>Emporio Legal | Títulos y Certificados</title>
@endsection
@section('styles')
<!-- Toastr -->
...
@section('main-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Bitácora de Títulos y Certificados <label id="label-estatus" class="label label-warning">Pendientes</label>
            </h1>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Bitácora de Títulos y Certificados</li>
            </ol>
        </section>
            ...
            <div id="crud" class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        @include('admin.bitacoras.titulos-certificados.alta-estatus')
                        @include('admin.bitacoras.titulos-certificados.entrega-titulo')
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
                </div>
