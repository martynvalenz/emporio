        ...
        <tbody style="font-size: 15px" id="list" name="list">
            @foreach($estatus as $estatus)
                <tr>
                    ...
                    <td align="center" title="{{ $estatus->bitacora }}" data-tooltip="tooltip">{{ $estatus->clave }}</td>
                    ...
                    <td align="center">
                        ...
                        @else
                            {{ $estatus->fecha_comprobacion_uso }} <i class="fas fa-times" style="color: red"></i>
                        @endif
                    </td>
                    <td align="center">
                    ...
                    <td align="center">
                        <a class="btn btn-success btn-flat btn-xs" onclick="EnviarDatosEstatus({{ $estatus->id }})" data-tooltip="tooltip">
