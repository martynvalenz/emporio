<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" role="dialog" id="modal-correo-{{ $razon->id }}">
	{{ Form::Open(array('action'=>array('ClienteRazonesController@correo', $razon->id), 'method'=>'put')) }}
