<div class="modal fade modal-slide-in-right" aria-text="true" role="dialog" tabindex="-1" id="modal-comision">
			...
			<div class="modal-body">
				...
				<div class="row pull-left">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<button type="button" id="btn-guardar-comision" class="btn btn-success btn-flat" title="Guardar comisión" data-tooltip="tooltip">
