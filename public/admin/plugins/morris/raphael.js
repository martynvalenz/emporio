...
}(this, function(a, b)
{
    ...
    return nc.attr = function(a, b)
        ...
        {
            if (c.is(a, "array"))
                for (var b, d = this.set(), e = 0, f = a.length; f > e; e++) b = a[e] ||
        ...
        function()
        {
            if (c.svg)
            {
                ...
                var q = function(d, e)
                    ...
                    z = function(a, b)
                    {
                        this[0] = this.node = a, a.raphael = !0, this.id = c._oid++, a.raphaelid = this.id, this.matrix = c.matrix(), this.realPath = null, this.paper = b, this.attrs = this.attrs ||
                        {}, this._ = {
                            transform: [],
                            sx: 1,
                            sy: 1,
