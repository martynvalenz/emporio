...
@section('title')
<title>Emporio Legal | Crear clase</title>
@endsection
  ...
  <section class="content">
    <div class="box box-default">
      <div class="box-header with-border">
          ...
          <div class="box-body">
            <form role="form" action="{{ route('clases.store') }}" method="post">
            {{ csrf_field() }}
              ...
              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                <div class="form-group {{ $errors->has('clave') ? ' has-error' : '' }}">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Clase #..." name="clave" id="clave" value="{{ old('clave') }}">
                  </div>
                  @if ($errors->has('clave'))
              ...
              <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                <div class="form-group {{ $errors->has('clase') ? ' has-error' : '' }}">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Servicios o Bienes" name="clase" id="clase" value="{{ old('clase') }}">
                  </div>
                  @if ($errors->has('clase'))
                      <span class="help-block">
