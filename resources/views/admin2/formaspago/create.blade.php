  ...
  <section class="content">
    <div class="box box-default">
      <div class="box-header with-border">
          ...
          <div class="box-body">
            <form role="form" action="{{ route('formaspago.store') }}" method="post">
            {{ csrf_field() }}
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="form-group {{ $errors->has('codigo') ? ' has-error' : '' }}">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Código fiscal..." name="codigo" id="codigo" value="{{ old('codigo') }}" autofocus>
                  </div>
              ...
              <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="form-group {{ $errors->has('forma_pago') ? ' has-error' : '' }}">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Forma de Pago..." name="forma_pago" id="forma_pago" value="{{ old('forma_pago') }}">
                  </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                ...
                <textarea rows="3" class="form-control has-feedback-left" placeholder="Anote una descripción para la forma de pago..." name="descripcion"></textarea>
