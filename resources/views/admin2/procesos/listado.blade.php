    ...
    <table id="example1" class="table table-striped table-bordered table-condensed table-hover display table-responsive no-wrap cell-border" cellspacing="0" width="100%">
        <thead style="font-size: 15px; color:white; background-color:#218CBF">
            <tr>
                ...
                <th data-tooltip="tooltip" title="Fecha de término en la bitácora o presentación">Bitácora</th>
                <th colspan ="1">&nbsp;</th>
            </tr>
        </thead>
        <tbody style="font-size: 15px" id="list" name="list">
            ...
            <tr id="servicio-{{ $servicio->id }}">
                ...
                <td style="width:18%;" align="center">
                    <a class="btn btn-xs btn-default btn-flat btn-comentarios-modal" onclick="Comentarios({{ $servicio->id }}, {{ $servicio->id_estatus }})" data-target="#comentarios-modal" data-toggle="modal" data-tooltip="tooltip" title="Comentarios" data-token="{{ csrf_token() }}">
