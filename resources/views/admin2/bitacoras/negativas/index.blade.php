@extends('admin.app')
@section('title')
<title>Emporio Legal | Negativas</title>
@endsection
@section('styles')
<!-- Toastr -->
...
@section('main-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Bitácora de Negativas <label id="label-estatus" class="label label-warning">Pendientes</label>
            </h1>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Bitácora de Negativas</li>
            </ol>
        </section>
            ...
            <div id="crud" class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        @include('admin.bitacoras.negativas.recepcion-alta')
                        @include('admin.bitacoras.negativas.elaboracion-notificacion')
                        @include('admin.bitacoras.negativas.revision')
                        @include('admin.bitacoras.negativas.envio-notificacion')
                        @include('admin.bitacoras.negativas.terminar-negativa')
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
                </div>
