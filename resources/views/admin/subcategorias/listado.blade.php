...
<table id="example1" class="table display table-responsive no-wrap table-bordered table-striped table-hover cell-border" cellspacing="0" width="100%">
    <thead>
        <tr>
            <th>Subcategoría</th>
            <th>Bitácora de Estatus</th>
            <th>Renovación</th>
            <th>Declaración</th>
            <th>Recordatorio</th>
            <th>Vencimiento</th>
