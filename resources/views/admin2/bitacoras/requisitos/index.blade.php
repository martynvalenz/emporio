@extends('admin.app')
@section('title')
<title>Emporio Legal | Requisitos y Objeciones</title>
@endsection
@section('styles')
<!-- Toastr -->
...
@section('main-content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Bitácora de Requisitos y Objeciones <label id="label-estatus" class="label label-warning">Pendientes</label>
            </h1>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Bitácora de Requisitos y Objeciones</li>
            </ol>
        </section>
            ...
            <div id="crud" class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        @include('admin.bitacoras.requisitos.recepcion-alta')
                        @include('admin.bitacoras.requisitos.elaboracion-notificacion')
                        @include('admin.bitacoras.requisitos.revision')
                        @include('admin.bitacoras.requisitos.terminar')
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
                </div>
