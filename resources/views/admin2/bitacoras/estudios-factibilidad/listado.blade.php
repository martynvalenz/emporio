    ...
    <table id="example1" class="table table-striped table-bordered table-condensed table-hover display table-responsive no-wrap cell-border" cellspacing="0" width="100%">
        <thead style="font-size: 15px">
            <tr>
                ...
                <th style="background-color: red; color:white" title="Fecha de Pago" data-tooltip="tooltip"><i class="far fa-money-bill-alt"></i></th>
                <th style="background-color: #00ff99" title="Recepción" data-tooltip="tooltip"><i class="glyphicon glyphicon-level-up" aria-hidden="true"></i></th>
                <th style="background-color: #00ff99" title="Elaboración" data-tooltip="tooltip"><i class="fas fa-clipboard-check"></i></i></th>
                <th style="background-color: gray; color:white" title="Revisión" data-tooltip="tooltip"><i class="fa fa-search-plus" aria-hidden="true"></i></th>
                <th style="background-color: #ff99ff" title="Envío" data-tooltip="tooltip"><i class="far fa-share-square"></i></th>
                <th style="background-color: #ff99ff" title="Fecha de Registro" data-tooltip="tooltip"><i class="fas fa-calendar-check"></i></th>
                <th style="background-color: #ff99ff" title="Explicación en caso de no Registrarse" data-tooltip="tooltip"><i class="far fa-comment-alt"></i></th>
