<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="agregar">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form role="form" action="{{ route('estrategias.store') }}" method="post">
			{{ csrf_field() }}
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group {{ $errors->has('estrategia') ? ' has-error' : '' }}">
							  ...
							  <div class="input-group">
							    ...
							    <input type="text" class="form-control" placeholder="Nombre  estrategia..." name="estrategia" id="estrategia" value="{{old('estrategia')}}">
							  </div>
