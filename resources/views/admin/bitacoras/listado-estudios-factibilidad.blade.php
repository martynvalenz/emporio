...
<div class="pagination-estudios-factibilidad">
    {{$servicios->render()}}
</div>
<div class="table-responsive">
    <table class="table headerfix table-striped table-bordered table-condensed table-hover display no-wrap cell-border" cellspacing="0" width="100%">
        ...
        <tbody style="font-size: 15px" id="list-estudios-factibilidad" name="list-estudios-factibilidad">
            @foreach($servicios as $key => $servicio)
            <tr id="listado-estudios-factibilidad-{{ $servicio->id }}">
