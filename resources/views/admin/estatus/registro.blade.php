			...
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<select class="form-control default-select2" name="cliente_select" id="cliente_select" data-live-search="true" data-style="btn-primary"></select>
								</div>
								<span class="help-block">
								    <strong id="cliente_select_error" style="color:red"></strong>
								</span>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bool_servicio">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<select name="servicio_select" id="servicio_select" class="form-control">
										<option value="">-Sin selección-</option>
									</select>
								</div>
								<span class="help-block">
								    <strong id="servicio_select_error" style="color:red"></strong>
								</span>
							</div>
						</div>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="bool_marca">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" id="marca_tramites" class="form-control">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row" id="tipo_bitacora">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" id="bool_declaracion_uso">
							<div class="form-group">
