...
<div id="content" class="content">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="btn-group">
                <a class="btn btn-primary btn-flat" href="{{ route('servicios.create') }}" title="Agregar registro" data-tooltip="tooltip"><i class="fa fa-plus"></i> Servicio
                </a>
                @include('admin.servicios.servicio')
                <a class="btn btn-success btn-flat"><i class="fas fa-money-bill-alt"></i> Comisiones</a>
                <a onclick="Exportar()" class="btn btn-default btn-flat"><i class="far fa-file-excel"></i> Exportar</a>
                <a class="btn btn-default" title="Ayuda">?</a>
            </div>
        </div>
    </div>
    <br>
