<div class="tab-pane fade show active" id="control-servicios">
    <input type="hidden" name="id_sesion" id="id_sesion" value="{{ Auth::user()->id }}">
    <input type="hidden" name="url_listar" id="url_listar" value="/admin/procesos-listar/">
    <input type="hidden" name="url_buscar" id="url_buscar" value="/admin/procesos-buscar/">
    <input type="hidden" name="url_actualizar" id="url_actualizar" value="/admin/procesos/actualizar/">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            @if (count($errors)>0)
                <div class="alert alert-danger fade show">
                    ...
                    <h4 style="color: #964748">No se pudo guardar el registro, corrija los errores en el formulario.</h4>
                    <ul>
