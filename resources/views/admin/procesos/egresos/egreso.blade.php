<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" role="dialog" id="modal-egreso">
	<form>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<select class="form-control" id="proveedor_egreso">
		                     		...
		                     		<input type="hidden" id="id_proveedor_egreso">
		                     		<input type="hidden" id="realiza_pagos_egreso">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<select name="tipo_egreso" id="tipo_egreso" class="form-control">
										...
										<option value="Personal">Nómina</option>
										<option value="Personal">Comisión</option>
										<option value="Personal">Traspaso</option>
									</select>
								</div>
								<span class="help-block">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="form-group">
								<label for="fecha_egreso">Fecha de Pago <span style="color:red">*</span></label>
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									<input type="input" name="fecha_egreso" id="fecha_egreso" class="form-control datepicker-autoClose centered" autocomplete="off" style="text-align: center">
								</div>
								<span class="help-block">
								    <strong id="fecha_egreso_error" style="color:red"></strong>
								</span>
							</div>
						</div>
					</div>
							...
							<div class="form-group">
								...
								<div class="input-group m-b-10">
									<div class="input-group-prepend">
										<span class="input-group-text"><input type="checkbox" id="check_porcentaje_iva_egreso" /></span>
									</div>
									<input type="number" step="any" class="form-control centered" value="{{ $porcentaje_iva->porcentaje_iva }}" id="porcentaje_iva_egreso" />
									<input type="hidden" id="check_porcentaje_iva_egreso_val" value="0">
								</div>
								<span class="help-block">
						...
						<div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="number" step="any" id="monto_egreso" name="monto_egreso" class="form-control"  style="text-align: center" value="0">
									<input type="hidden" id="monto_egreso_val" value="0">
								</div>
								<span class="help-block">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div id="listado-egreso-pagos"></div>
						</div>
					</div>
				...
				<div class="modal-footer">
					<input type="hidden" id="id_egreso_egreso">
					<input type="hidden" id="orden_egreso">
					<input type="hidden" id="accion_egreso" value="Create">
