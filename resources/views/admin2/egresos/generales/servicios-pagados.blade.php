<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<h4>Servicios asignados al egreso</h4>
			        ...
			        <tbody style="font-size: 15px" id="list" name="list">
			            ...
			            <tr id="servicio{{ $servicio->id }}">
			                ...
			                <td style="width:6%;" align="center">
			                	<a id="btn-eliminar" class="btn btn-danger btn-xs btn-flat" title="Eliminar servicio del egreso" data-tooltip="tooltip"><i class="fas fa-times"></i></a>
			                </td>
			            </tr>
			            @endforeach
			        </tbody>
