...
class RequisitosController extends Controller
{
    public function index()
    {
        ...
        $url_listar = '/admin/bitacora/requisitos-listar/';
        $url_buscar = '/admin/bitacora/requisitos-buscar/';
        $url_actualizar = '/admin/bitacora/requisitos/actualizar-servicio/';

        return view('admin.bitacoras.requisitos.index', compact('monedas', 'admins', 'porcentaje_iva', 'cuentas', 'formas_pago', 'variable_estatus', 'clases', 'bitacoras', 'estrategias', 'url_listar', 'url_buscar', 'fecha_inicio', 'fecha_fin', 'tipo_vista', 'bitacoras_estatus', 'url_actualizar', 'today'));
    }
    ...
    public function listar($estatus, $fecha_inicio, $fecha_fin)
    {
        if($estatus == 'todos')
        {
            ...
            return view('admin.bitacoras.requisitos.listado', compact('servicios', 'today'));    
        }
        else
        {
            Carbon::setLocale('es');
    ...
    public function buscar($estatus, $buscar, $fecha_inicio, $fecha_fin)
    {
        ...
        else
        {
            ...
            return view('admin.bitacoras.requisitos.listado', compact('servicios', 'facturas', 'today'));
        }
    }
    ...
    public function actualizarServicio($id_servicio)
    {
        ...
        return view('admin.bitacoras.requisitos.listado-servicios', compact('servicio', 'today'));
    }

    public function Requisitos(Request $request, $id)
    {
        ...
        if($request->vencimiento_tramite_fecha != '')
        {
            $servicio->vencimiento_tramite_fecha=$request->vencimiento_tramite_fecha;
            $servicio->vencimiento_tramite_boolean= 1;
        }
        else
        {
            $servicio->vencimiento_tramite_fecha = null;
            $servicio->vencimiento_tramite_boolean = 0;
        }
    ...
    public function Notificacion(Request $request, $id)
    {
        $servicio = Servicios::findOrFail($id);
    ...
    public function Revision(Request $request, $id)
    {
        ...
        if($request->presentacion != '')
        {
            $this->validate($request,
                [
                    'presentacion_fecha' => 'required'
                ]);

            $servicio->presentacion_boolean=1;
            $servicio->presentacion=$request->presentacion;
            $servicio->presentacion_fecha=$request->presentacion_fecha;
        }
        else
        {
            $servicio->presentacion_boolean=0;
            $servicio->presentacion=$request->presentacion;
        ...
        /*if($request->alta_estatus == 'Realizado')
        {
            if($request->alta_estatus_fecha == $request->alta_estatus_fecha_val && $request->alta_estatus == $request->alta_estatus_val)
            {

            }
            else if($request->alta_estatus_fecha != $request->alta_estatus_fecha_val || $request->alta_estatus != $request->alta_estatus_val)
            {
                $servicio->listo_comision_operativa = '1';
                $servicio->listo_comision_venta = '1';
                $servicio->listo_comision_gestion = '1';
                $servicio->fecha_comision_operativa = $request->alta_estatus_fecha;
                $servicio->fecha_comision_venta = $request->alta_estatus_fecha;
                $servicio->fecha_comision_gestion = $request->alta_estatus_fecha;
                ...
                $comision = DB::table('nomina')
                    ...
                    ->update(['listo_comision' => '1',
                                'estatus' => 'Liberada',
                                'fecha_aplicada' => $request->alta_estatus_fecha
                            ]);
            }
        }
        else if($request->alta_estatus == 'Cancelado')
        {
    ...
    public function Terminar(Request $request, $id)
    {
        ...
        if($request->alta_control_archivar != '')
        {
            $this->validate($request,
                [
                    'alta_control_archivar_fecha' => 'required'
                ]);

            $servicio->alta_control_archivar_boolean=1;
            $servicio->alta_control_archivar=$request->alta_control_archivar;
            $servicio->alta_control_archivar_fecha=$request->alta_control_archivar_fecha;
        }
        else
        {
            $servicio->alta_control_archivar_boolean=0;
            $servicio->alta_control_archivar=$request->alta_control_archivar;
            $servicio->alta_control_archivar_fecha=null;
        }
        ...
        if($request->estatus_tramite == 'Terminado')
        {
            ...
            $servicio->listo_comision_venta = '1';
            $servicio->listo_comision_gestion = '1';
            $servicio->fecha_comision_operativa = $request->alta_control_archivar_fecha;
            ...
            $servicio->presentacion_fecha = $request->alta_control_archivar_fecha;
            ...
            $comision = DB::table('nomina')
                ...
                ->update(['listo_comision' => '1',
                            'estatus' => 'Liberada',
                            'fecha_aplicada' => $request->alta_control_archivar_fecha
                        ]);
        }
