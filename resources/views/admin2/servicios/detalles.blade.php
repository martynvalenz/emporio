<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" role="dialog" id="detalles-modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #737373;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
                <span aria-hidden="true" style="font-size: 35px; color: black;"><b>&times;</b></span>
                </button>
                <h4 class="modal-title" style="color: white;" id="detalles-titulo"></h4>
            </div>
                    ...
                    <div class="col-3 col-md-3 col-sm-4 col-xs-12">
                        <div class="form-group">
                            <label for="estatus" class="container">Estatus
                                <input type="checkbox" id="det_estatus">
