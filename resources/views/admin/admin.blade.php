...
@section('main-content')
	<div id="content" class="content">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<h2>Trámites pendientes en Bitácoras</h2>
			</div>
			<!-- begin col-3 -->
			<div class="col-lg-3 col-md-6">
				<div class="widget widget-stats bg-gradient-blue">
					<div class="stats-icon stats-icon-lg"><i class="fas fa-file-alt fa-fw"></i></div>
					<div class="stats-content">
						<div class="stats-title"><b>TRÁMITES NUEVOS</b></div>
						<div class="stats-number">{{ number_format($tramites_nuevos, 0) }}</div>
						{{-- <div class="stats-progress progress">
							<div class="progress-bar facturas_pendientes"></div>
						</div>
						<div class="stats-desc porcentaje_pagado" style="font-weight: bold"></div> --}}
			...
			<div class="col-lg-3 col-md-6">
				<div class="widget widget-stats bg-gradient-purple">
					<div class="stats-icon stats-icon-lg"><i class="fas fa-search fa-fw"></i></div>
					<div class="stats-content">
						<div class="stats-title"><b>ESTUDIOS DE FACTIBILIDAD</b></div>
						<div class="stats-number">{{ number_format($estudios_factibilidad, 0) }}</div>
			...
			<div class="col-lg-3 col-md-6">
				<div class="widget widget-stats bg-gradient-orange">
					<div class="stats-icon stats-icon-lg"><i class="far fa-folder-open fa-fw"></i></div>
					<div class="stats-content">
						<div class="stats-title"><b>TÍTULOS Y CERTIFICADOS</b></div>
						<div class="stats-number">{{ number_format($titulos_certificados, 0) }}</div>
					</div>
				</div>
			</div>
			<!-- end col-3 -->
			...
			<div class="col-lg-3 col-md-6">
				<div class="widget widget-stats bg-gradient-green">
					<div class="stats-icon stats-icon-lg"><i class="far fa-comment-alt fa-fw"></i></div>
					<div class="stats-content">
						<div class="stats-title"><b>REQUISITOS Y OBJECIONES</b></div>
						<div class="stats-number">{{ number_format($requisitos_objeciones, 0) }}</div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-3 col-md-6">
				<div class="widget widget-stats bg-gradient-red">
					<div class="stats-icon stats-icon-lg"><i class="fas fa-times fa-fw"></i></div>
					<div class="stats-content">
						<div class="stats-title"><b>NEGATIVAS</b></div>
						<div class="stats-number">{{ number_format($negativas, 0) }}</div>
					</div>
				</div>
			</div>
			<!-- end col-3 -->
