				    ...
				    <div class="form-group">
				      ...
				      <div class="input-group">
				        ...
				        @if($razon->subcarpeta == null)
							<input type="text" class="form-control" placeholder="URL de subcarpeta..." name="subcarpeta" id="subcarpeta" value="{{ $razon->subcarpeta }}">
				        @else
				    ...
				    <div class="form-group">
				      ...
				      <div class="input-group">
				        ...
				        @if($razon->correo == null)
							<input type="email"  class="form-control" placeholder="Email de facturacion...">
				        @else
