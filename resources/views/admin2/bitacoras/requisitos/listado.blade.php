    ...
    <table class="table table-striped table-bordered table-condensed table-hover display table-responsive no-wrap cell-border" cellspacing="0" width="100%">
        <thead style="font-size: 15px">
            <tr>
                ...
                <th style="background-color: #ff3300; color:white" title="Recepción y Alta en estatus" data-tooltip="tooltip"><i class="fas fa-sign-in-alt"></i></th>
                <th style="background-color: #ff3300; color:white" title="Escaneo de documentos" data-tooltip="tooltip"><i class="fa fa-print" aria-hidden="true"></i></th>
                <th style="background-color: #00ff99" title="Elaboración de Notificación" data-tooltip="tooltip"><i class="fas fa-clipboard-list"></i></th>
                <th style="background-color: #00ff99" title="Envío de Notificación" data-tooltip="tooltip"><i class="fas fa-paper-plane"></i></th>
                <th style="background-color: #00ff99" title="Cobro" data-tooltip="tooltip"><i class="fas fa-money-bill-alt"></i></th>
                <th style="background-color: #d6d6d6" title="Revisión" data-tooltip="tooltip"><i class="fas fa-search"></i></th>
                <th style="background-color: #d6d6d6" title="Presentación" data-tooltip="tooltip"><i class="fas fa-clipboard-check"></i></th>
                <th style="background-color: #d6d6d6" title="Alta en Estatus" data-tooltip="tooltip"><i class="fas fa-database"></i></th>
                <th style="background-color: #ff3300; color:white" title="Control y archivar" data-tooltip="tooltip"><i class="fas fa-archive"></i></th>
                <th style="background-color: #ff3300; color:white" title="Vencimiento" data-tooltip="tooltip"><i class="fas fa-calendar-check"></i></th>
                <th style="color:white; background-color:#218CBF">Creado</th>
                <th style="color:white; background-color:#218CBF" title="Estatus de cobranza del servicio" data-tooltip="tooltip">Cobranza</th>
                <th style="color:white; background-color:#218CBF" data-tooltip="tooltip" title="Estatus del servicio en su bitácora correspondiente">Trámite</th>
                <th style="color:white; background-color:#218CBF" colspan ="1">&nbsp;</th>
            </tr>
        </thead>
